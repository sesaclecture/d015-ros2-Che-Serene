...
def task_source_ros() -> tuple[int, str, str]:
    ...
    """
    # TODO: 여기에 코드를 작성하시오
    cmd = "source /opt/ros/jazzy/setup.bash && printenv" 
...
def task_docker_run_cmd() -> str:
    ...
    # TDO: 여기에 코드를 작성하시오
    return (
        "docker run -it --rm --name humble-gui --network=host -v /tmp/.X11-unix:/tmp/.X11-unix:rw -e DISPLAY=$DISPLAY -e ROS_DOMAIN_ID=24 -e RMW_IMPLEMENTATION=rmw_cyclonedds_cpp arm64v8/ros:humble bash"
    )
